...
public interface TecnicoRepository extends JpaRepository<Tecnico, Long> {
    ...
    //1- un método que cree un nuevo Director Técnico, este método es save en el repository

    //2- un método para agregar jugadores al técnico,
    // debemos agregar un jugador al tecnico desde el add collection y despues save.
